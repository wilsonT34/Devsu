...
public class CuentaService {
    ...
    private final ModelMapper modelMapper;
      private final ClienteLocalRepository clienteLocalRepository; // Agregar
    ...
    public CuentaDTO crearCuenta(CuentaDTO cuentaDTO) {
        ...
        // VALIDAR QUE EL CLIENTE EXISTE USANDO findById
        if (!clienteLocalRepository.findById(cuentaDTO.getClienteid()).isPresent()) {
            throw new RuntimeException("El cliente con ID " + cuentaDTO.getClienteid()
